 ...
 * this to submitter_id = auth.uid()) for the "My questions" tab; the rest
 * of the page's mock poll/feedback data is handled client-side for now.
 */
...
export default async function PollsPage() {
  ...
  return <PollsPageClient initialQuestions={myQuestions} />;
}
